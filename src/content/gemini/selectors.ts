...
export const GEMINI_MODEL_RESPONSE_SELECTOR =
  'message-content.model-response-text, message-content, .model-response-text, [data-test-id="model-response"], [data-message-author-role="model"]';
