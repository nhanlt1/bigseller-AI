...
const UI_NOISE_LINE = /^(copy|copy code|copied|share|regenerate|thử lại|good response|bad response|đề xuất)$/i;
...
export function hashProductContent(title, description) {
