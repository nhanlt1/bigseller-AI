 ...
 * Selector form sản phẩm BigSeller / Shopee Seller
 */
export const PRODUCT_FIELD_ELEMENTS = [
    {
        key: 'title',
        label: 'Tên sản phẩm',
        maxLength: 120,
        ...
        bigseller: {
            ...
            domPath: 'div#app > div.__root > div.page_edit > div.page_edit_body > div.com_card.mb_20:nth-child(1) > div.com_card_body > form.ant-form > div.page_edit_item:nth-child(2) > div.content > div.product_name > div.ant-form-item-control > span.ant-form-item-children > span.ant-input-group-wrapper > span.ant-input-group > input.ant-input',
            kind: 'input',
            htmlHints: {
        ...
        shopee: {
            ...
            domPath: 'div#app > div.full-screen-container > div.page > div.product > div.product-detail > div.product-edit > div.product-edit__main > section.product-edit__section:nth-child(1) > div.product-detail-panel.product-basic-info > div.panel-content > div.edit-row > div.edit-main > div.product-name-editor > div.product-edit-form-item > div.product-edit-form-item-content > div.eds-input > div.eds-input__inner--large > input.eds-input__input',
            kind: 'input',
            htmlHints: {
    ...
    },
    {
        ...
        maxLength: 3000,
        inputNotes: 'Tối đa 3000 ký tự; chỉ văn bản thuần, có thể xuống dòng, không định dạng rich text',
        bigseller: {
            platform: 'bigseller',
            selectors: [
            ...
            domPath: 'div#app > div.__root > div.page_edit > div.page_edit_body > div.com_card.mb_20:nth-child(2) > div.com_card_body > form.ant-form > div.page_edit_item:nth-child(3) > div.content > div.ant-form-item > span.ant-form-item-children > div.textarea_count > textarea.w_full.min_h_250.ant-input',
            kind: 'textarea',
            htmlHints: {
        ...
        shopee: {
            ...
            domPath: 'div#app > div.full-screen-container > div.page > div.product > div.product-detail > div.product-edit > div.product-edit__main > section > div.product-detail-panel > div.panel-content > div.editor-outer',
...
export function getFieldSelectors(key, platform) {
...
export function getFieldMaxLength(key) {
...
export const BIGSELLER_DESCRIPTION_SELECTORS = getFieldSelectors('description', 'bigseller');
export const SHOPEE_TITLE_SELECTORS = getFieldSelectors('title', 'shopee');
export const SHOPEE_DESCRIPTION_SELECTORS = getFieldSelectors('description', 'shopee');
